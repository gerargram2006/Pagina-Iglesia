export default function PastorsSection({ title = "Nuestros Pastores", subtitle = "Liderazgo espiritual al servicio de Dios", id = "pastores" }) {
    const pastors = [
        { name: "Pastor Ruideto Costa", role: "Pastor Principal", description: "Más de 10 años dedicados al ministerio pastoral y la enseñanza bíblica.", initials: "JP", hasPhoto: true, photoSrc: "/img/pastor-principal.webp" },
    ];
